    ...
    def camera_settings(self):
        if type(appglobals.camera) is ascomequipment.Camera:
            ...
            if controls["Gamma"]["IsAutoSupported"]:
                self.camera_settings_frame.gamma_label.setEnabled(True)
                self.camera_settings_frame.gamma_spinbox.setEnabled(True)
                ...
                self.camera_settings_frame.gamma_label.setEnabled(False)
                self.camera_settings_frame.gamma_spinbox.setEnabled(False)
            if controls["Brightness"]["IsAutoSupported"]:
                self.camera_settings_frame.brightness_label.setEnabled(True)
                self.camera_settings_frame.brightness_spinbox.setEnabled(True)
                ...
                self.camera_settings_frame.brightness_label.setEnabled(False)
                self.camera_settings_frame.brightness_spinbox.setEnabled(False)
            if controls["WB_R"]["IsAutoSupported"]:
                self.camera_settings_frame.red_label.setEnabled(True)
                self.camera_settings_frame.red_spinbox.setEnabled(True)
                ...
                self.camera_settings_frame.red_label.setEnabled(False)
                self.camera_settings_frame.red_spinbox.setEnabled(False)
            if controls["WB_B"]["IsAutoSupported"]:
                self.camera_settings_frame.blue_label.setEnabled(True)
                self.camera_settings_frame.blue_spinbox.setEnabled(True)
                ...
                self.camera_settings_frame.blue_label.setEnabled(False)
                self.camera_settings_frame.blue_spinbox.setEnabled(False)
            if controls["BandWidth"]["IsAutoSupported"]:
                self.camera_settings_frame.usb_label.setEnabled(True)
                self.camera_settings_frame.usb_spinbox.setEnabled(True)
                ...
                self.camera_settings_frame.usb_label.setEnabled(False)
                self.camera_settings_frame.usb_spinbox.setEnabled(False)
            if controls["Flip"]["IsAutoSupported"]:
                self.camera_settings_frame.horizontalflip_checkbox.setEnabled(True)
                self.camera_settings_frame.verticalflip_checkbox.setEnabled(True)
                ...
                self.camera_settings_frame.horizontalflip_checkbox.setEnabled(False)
                self.camera_settings_frame.verticalflip_checkbox.setEnabled(False)
            if controls["HardwareBin"]["IsAutoSupported"]:
                self.camera_settings_frame.hardwarebin_checkbox.setEnabled(True)
                ...
                self.camera_settings_frame.hardwarebin_checkbox.setEnabled(False)
            if controls["HighSpeedMode"]["IsAutoSupported"]:
                self.camera_settings_frame.highspeed_checkbox.setEnabled(True)
                ...
                self.camera_settings_frame.highspeed_checkbox.setEnabled(False)
            if controls["Mono bin"]["IsAutoSupported"]:
                self.camera_settings_frame.monobin_checkbox.setEnabled(True)
                ...
                self.camera_settings_frame.monobin_checkbox.setEnabled(False)
            if controls["Temperature"]["IsAutoSupported"]:
                self.camera_settings_frame.temperature_label.setEnabled(True)
                self.camera_settings_frame.temperature_spinbox.setEnabled(True)
                ...
                self.camera_settings_frame.temperature_label.setEnabled(False)
                self.camera_settings_frame.temperature_spinbox.setEnabled(False)
