...
class Ui_ScheduleBrainDialog(object):
    def setupUi(self, ScheduleBrainDialog):
        ...
        ScheduleBrainDialog.resize(472, 158)
    ...
    def retranslateUi(self, ScheduleBrainDialog):
        ...
        self.east_radiobutton.setToolTip(_translate("ScheduleBrainDialog", "Prefer object to be on the eastern side of the sky"))
        self.east_radiobutton.setText(_translate("ScheduleBrainDialog", "East"))
        self.west_radiobutton.setToolTip(_translate("ScheduleBrainDialog", "Prefer object to be on the western side of the sky"))
